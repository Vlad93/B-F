...
if (sections.length > 1) {
  sections[1].id = "next-section";
} else {
  document.querySelector('.header__next-section-btn').style.display = 'none';
}
